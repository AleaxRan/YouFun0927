package com.atguigu.youfun0927.view.verticalsilde;
...
/**
 * Created by Gavin on 2016/10/9 10:25
 * Function: 只为顶部ScrollView使用,如果使用了其它的可拖拽的控件，请仿照该类实现isAtBottom方法
 */
public class DrayScrollView extends ScrollView {
    ...
    public DrayScrollView(Context arg0) {
        this(arg0, null);
    }

    public DrayScrollView(Context arg0, AttributeSet arg1) {
        this(arg0, arg1, 0);
    }

    public DrayScrollView(Context arg0, AttributeSet arg1, int arg2) {
