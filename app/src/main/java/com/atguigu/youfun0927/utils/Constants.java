...
public class Constants {
    ...
    //    分类品类男
    public static final String KIND_PINLEI_MEN = "http://api.funwear.com/mbfun_server/index.php?m=Category&a=getCategoryList&cid=1&osCode=android&osVersion=19&deviceId=ffffffff-a66b-bc18-95f9-8e737e716946&token=&source=android&version=v4.2.2&osName=SM-G3818&appName=youfanguanfang";

    //分类品牌男
    public static final String KIND_PINPAI_MEN = "http://api.funwear.com/mbfun_server/index.php?m=BrandMb&a=getAppBrandList&osVersion=22&pageIndex=0&appName=youfanguanfang&pageSize=45&cid=1";
